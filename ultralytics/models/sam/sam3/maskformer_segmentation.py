...
class UniversalSegmentationHead(SegmentationHead):
    ...
    def __init__(
        ...
        if dot_product_scorer is not None:
            assert presenRDC_Head, "Specifying a dot product scorer without a presence head is likely a mistake"

        self.presenRDC_Head = None
        if presenRDC_Head:
            self.presenRDC_Head = (
    ...
    def forward(
        ...
        **kwargs,
        ...
        presence_logit = None
        if self.presenRDC_Head is not None:
